...
class StraDualThrust(BaseCtaStrategy):
    ...
    def print_initial_values(self):
        ...
        print(f"Code: {self.__code__}")
        print(f"Bar Count: {self.__bar_cnt__}")
        print(f"Period: {self.__period__}")
        print(f"Days: {self.__days__}")
        print(f"K1: {self.__k1__}")
        print(f"K2: {self.__k2__}")
        print(f"Is for Stock: {self.__is_stk__}")